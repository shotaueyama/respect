...
<body>
    ...
    <section class="u-pb-80 u-pt-80 u-sp-pt-120">
        ...
        <div class="p-center --width-894">
            ...
            <p class="u-pb-40">株式会社リスペクトフォース（以下当社）は美容機器販売、エステサロン新規開業を支援する商社として個人情報を保護し、お客様に更なる 信頼性と安心感をご提供できるように努めて参ります。</p>

            <h2 class="c-title --style-7">個人情報の取得について</h2>
            <p class="u-pb-40">当社は、個人情報に関する法令を遵守し、個人情報の適切な取り扱いを実現いたします。</p>

            <h2 class="c-title --style-7">個人情報の利用について</h2>
            <p class="u-pb-40">
                当社は、個人情報を以下の利用目的の達成に必要な範囲内で、利用いたします。<br>
                以下に定めのない目的で個人情報を利用する場合、あらかじめご本人の同意を得た上で行ないます。
            </p>
            <ul class="u-pb-40">
                <li>（１）　発注のご依頼・ご質問に対する回答及び資料送付</li>
                <li>（２）　ご注文いただいた商品の手配</li>
                <li>（３）　その他サービスに関する情報提供</li>
            </ul>

            <h2 class="c-title --style-7">個人情報の安全管理について</h2>
            <p class="u-pb-40">当社は、取り扱う個人情報の漏洩、滅失またはき損の防止その他の個人情報の安全管理のために必要かつ適切な措置を講じます。</p>

            <h2 class="c-title --style-7">個人情報の委託について</h2>
            <p class="u-pb-40">
                当社は、個人情報の取り扱いの全部または一部を第三者に委託する場合は、当該第三者について厳正な調査を行い、取り扱いを委託された個人情報の安全管理が図られるよう当該第三者に対する必要かつ適切な監督を行います。
            </p>

            <h2 class="c-title --style-7">個人情報の第三者提供について</h2>
            <p class="u-pb-40">当社は、個人情報保護法等の法令に定めのある場合を除き、個人情報をあらかじめご本人の同意を得ることなく、第三者に提供いたしません。</p>

            <h2 class="c-title --style-7">個人情報の開示・訂正等について</h2>
            <p class="u-pb-40">
                ...
                <br>
                【 連絡先 】株式会社リスペクトフォース<br>
                電話：03-5352-7722（10:00～18:00）<br>
            </p>

            <h2 class="c-title --style-7">組織・体制</h2>
            <p class="u-pb-40">
                当社は、代表取締役　境　恭介 を個人情報管理責任者とし、個人情報の適正な管理及び継続的な改善を実施いたします。
            </p>

            <h2 class="c-title --style-7">組本方針の変更</h2>
            <p class="u-pb-40">
    ...
    <div class="u-position-relative">
        ...
        <div class="u-bg-blue-2 u-color-black u-z-100 u-position-relative">

            <div class="p-center u-pt-80 u-pb-80 --width-894 u-sp-pt-120 u-sp-pb-120">

